...
export const musicComponentHelp = document.getElementById("music-component-help");
export const musicOpenComponentDir = document.getElementById("music-open-component-dir") as HTMLButtonElement | null;
export const musicRecheckComponent = document.getElementById("music-recheck-component") as HTMLButtonElement | null;
