...
export const weatherLocationModeSelect = document.getElementById("weather-location-mode") as HTMLSelectElement | null;
export const locationStatusField = document.getElementById("location-status-field") as HTMLElement | null;
export const locationStatus = document.getElementById("location-status") as HTMLElement | null;
export const refreshLocationBtn = document.getElementById("refresh-location-btn") as HTMLButtonElement | null;
export const timezoneModeSelect = document.getElementById("timezone-mode") as HTMLSelectElement | null;
export const manualTimezoneField = document.getElementById("manual-timezone-field") as HTMLElement | null;
export const userTimezoneInput = document.getElementById("user-timezone") as HTMLInputElement | null;
